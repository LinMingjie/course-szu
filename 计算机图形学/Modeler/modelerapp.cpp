...
ModelerControl::ModelerControl(const char* name, float minimum, float maximum, double stepsize, float value)
{
...
void ModelerControl::SetVals(const char* name, float minimum, float maximum, double stepsize, float value)
{
